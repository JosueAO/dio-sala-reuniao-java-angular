...
import org.springframework.web.bind.annotation.CrossOrigin; // "Permite" o Front consumir aplicação
...
@RestController @CrossOrigin(origins = "http://localhost:4200") // 4200 porta padrão do Angular
